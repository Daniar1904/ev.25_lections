...
# globals() -> возвращает dict в котором описаны все имена, которые содержит глобальное пространство
# locals() -> возвращает dict в котором описаны все имена, которые содержит локальное пространство
