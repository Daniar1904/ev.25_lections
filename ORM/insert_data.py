...
def add_product(name, price, category_name):
    ...
    if category_exists:
        data = Product(
            title = name, price = price, category_id = category
        )
        data.save()
...
# add_product('ZARA t_shirt', 300, 'Футболки')
# add_product('Supreme t_shirt', 200, 'Футболки')
# add_product('DG t_shirt', 1000, 'Футболки')
# add_product('Aygen 48', 1500, 'Платья')
# add_product('Platye 50', 400, 'Платья')
# add_product('Lewys', 2000, 'Джинсы')
