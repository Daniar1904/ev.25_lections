...
#         if isinstance(ingredient, str): # checking(type)
...
# print(t1)
# print(TriangleChecker([1, 4, 9]))
# print(TriangleChecker([1, 4, 4]))
...
#     def __str__(self) -> str:
#         return f'Название этой песни {self.show_title}\nАвтор этой песни {self.show_author}\nЭта песня вышла в {self.show_year} году'
    
# a1 = Song('Happy', 'Pharrell Williams', 2013)
# print(a1)

    
    # def show_author(self):
    #     self.author = 'Williams'
