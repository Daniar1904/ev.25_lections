...
#     radius = property(fget=_get_radius, fset=set_radius, fdel=_del_radius, doc='The radius protected property')
# circle = Circle(15)
# print(circle.radius)
# circle.radius = 36
# print(circle.radius)
...
#     @property
#     def password(self):
#         raise AttributeError('Password field is write-only! You can\'t see the password! :)')
#     @password.setter
