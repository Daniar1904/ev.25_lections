...
# 2. Защищенный (protected, parent/child) = _number, def _get
# 3. Приватный(__private, частные, используются только в текущем классе) = __number, def __get
...
# print(audi._model)
# print(audi._country)
# print(audi._Car__motor) # не работает
...
# getter & setter
# Они используются для получение и установки значений, чтобы добавить логику валидации(проверки) данных, которые будут установлены в атрибуты и которые имеют защиту.
# Ещё для того, чтобы избежать прямого обращения к защищенному полю класса.
